  ...
  return (
    <div className="animate-fade-in w-full max-w-4xl mx-auto font-serif">
      ...
      <div className="text-center mt-12 flex flex-col sm:flex-row justify-center items-center gap-6">
        ...
        <button
            onClick={onUpdate}
            className="font-display text-white bg-case-text-secondary hover:bg-case-text-primary transition-all px-8 py-3 rounded-md shadow-lg font-bold flex items-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
