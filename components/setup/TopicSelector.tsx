...
const TopicSelector: React.FC<TopicSelectorProps> = ({
    ...
    return (
        <div className="animate-fade-in w-full max-w-2xl mx-auto">
            <h1 className="text-3xl sm:text-4xl font-bold text-text-primary mb-2 text-center">Configure Quiz</h1>
            <p className="text-text-secondary mb-8 text-center">For "{activeSet.name}"</p>
            ...
            <div className="bg-surface-dark p-6 sm:p-8 rounded-xl space-y-8">
                <div>
                    ...
                    <div className="flex flex-col gap-3 min-h-[10rem] overflow-y-auto pr-2">
                         {isAnalyzingTopics ? <div className="flex justify-center items-center h-full"><LoadingSpinner /></div> : topics && topics.length > 0 ? (
                            topics.map(topic => (
                        ...
                        ) : <div className="text-center text-text-secondary flex flex-col justify-center items-center h-full py-4"><p>No topics were generated.</p><p className="text-sm">Try regenerating or adding more content.</p></div>}
                    </div>
                </div>
