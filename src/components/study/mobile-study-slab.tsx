...
export function MobileStudySlab() {
    ...
    return (
        <div className="flex flex-col flex-1 mt-32 bg-[#141820]/95 backdrop-blur-3xl border-t border-white/10 rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.5)] relative z-10">
            ...
            <div className="flex justify-between px-8 border-b border-white/5 bg-[#141820]/50 backdrop-blur-xl z-20 shrink-0 sticky top-0">
                {['Material', 'Cards (45)', 'Stats'].map((tab) => (
                    <button
                        key={tab}
                    ...
                    <>
                        ...
                        <div className="p-4 rounded-2xl bg-gradient-to-br from-brand-primary/20 to-brand-secondary/5 border border-brand-primary/20 mb-6">
                            ...
                            <p className="text-sm text-gray-300 leading-relaxed">
                                This unit covers the 4 phases of Mitosis, the function of the Mitochondria, and DNA replication basics.
                            </p>
                        ...
                        <div className="space-y-3">
                            <div className="bg-white/5 p-4 rounded-xl flex items-center gap-4 border border-white/5">
                                ...
                                <div className="flex-1">
                                    <h4 className="text-sm font-medium text-white">Lecture_04.pdf</h4>
                            ...
                            <div className="bg-white/5 p-4 rounded-xl flex items-center gap-4 border border-white/5">
                                ...
                                <div className="flex-1">
                                    <h4 className="text-sm font-medium text-white">Wikipedia: Mitochondria</h4>
                                    <p className="text-xs text-gray-500">Web Source</p>
                                </div>
                            </div>
                        </div>
